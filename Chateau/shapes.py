...
def drawRoof(pen,x,y,w,h):
  ...
  pen.pendown()
  pen.color(0/255,0/255,0/255)
  pen.fillcolor(200/255,20/255,20/255)
  pen.begin_fill()
  pen.goto(x,y)
  pen.goto(x+w//2,y+h)
  pen.goto(x+w,y)
...
def drawDoor(pen,x,y,w,h):
  ...
  pen.goto(x-w//2,y)
  pen.pendown()
  pen.color(40/255,40/255,20/255)
  pen.fillcolor(40/255,40/255,20/255)
  pen.goto(x-w//2,y)
  pen.begin_fill()
...
def drawLoophole(pen,x,y,w,h):
  ...
  pen.pendown()
  pen.color(0/255,0/255,0/255)
  pen.fillcolor(0/255,0/255,0/255)
  pen.goto(x,y)
  pen.begin_fill()
  pen.goto(x+w//2,y)
  pen.goto(x+w//2,y+h)
